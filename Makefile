...
util: util.c
	$(CC) -o util util.c $(CFLAGS)

bruteforce: bruteforce.c
	$(CC) -o bruteforce util.c bruteforce.c $(CFLAGS)

printpoints: printpoints.c
	$(CC) -o printpoints printpoints.c $(CFLAGS)

genindexes: genindexes.o io.o
	$(CC) -o $@ $^ $(LDFLAGS)

verifyindexes: verifyindexes.o io.o
	$(CC) -o $@ $^ $(LDFLAGS)

kdtree: kdtree.o io.o
	$(CC) -o $@ $^ $(LDFLAGS)
